export default function GoblinButton({
    ...
    const variants = {
        ...
        hero:
            "rounded-2xl px-6 py-4 text-base font-bold border-[#F4A59E]/50 bg-[#241a28]/80 text-[#F7D8D2] shadow-[0_0_30px_rgba(244,165,158,0.20)] hover:-translate-y-1 hover:border-[#F4A59E]/80 hover:bg-[#2f2035]",
