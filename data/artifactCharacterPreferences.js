export const artifactCharacterPreferences = {
    ...
    venti: {
        wants: ["Elemental Mastery", "Energy Recharge"],
        mainStats: ["Elemental Mastery", "Anemo DMG", "Elemental Mastery"],
        verdict:
    ...
    albedo: {
        ...
        mainStats: ["DEF%", "Geo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Albedo wants DEF and crit. Paimon suspects elegant rock paperwork.",
    },
    ...
    barbara: {
        wants: ["HP%", "Energy Recharge"],
        mainStats: ["HP%", "HP%", "Healing Bonus"],
        verdict: "Barbara wants HP and healing. Paimon recommends hydration and emotional support.",
    },

    beidou: {
        wants: ["Energy Recharge", "Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Beidou wants ER, crit, and enough power to argue with the ocean.",
    },

    baizhu: {
        wants: ["HP%", "Energy Recharge"],
        mainStats: ["HP%", "HP%", "Healing Bonus"],
        verdict: "Baizhu wants HP and ER. Medical malpractice not detected.",
    },

    chongyun: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Cryo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Chongyun likes crit and attack. Exorcism paperwork approved.",
    },

    diluc: {
        wants: ["Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Pyro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Diluc wants crit and attack. Brooding efficiency increased.",
    },

    diona: {
        wants: ["HP%", "Energy Recharge"],
        mainStats: ["HP%", "HP%", "Healing Bonus"],
        verdict: "Diona wants HP and ER. The shield-and-healing department approves reluctantly.",
    },

    eula: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Physical DMG", "Crit Rate", "Crit Damage"],
        verdict: "Eula wants crit, attack, and physical damage. Vengeance has requested better substats.",
    },

    gaming: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Elemental Mastery"],
        mainStats: ["ATK%", "Pyro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Gaming likes crit, attack, and enough EM for responsible lion dancing.",
    },

    keqing: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Elemental Mastery"],
        mainStats: ["ATK%", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Keqing wants crit and attack. Work-life balance remains missing.",
    },

    ningguang: {
        wants: ["Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Geo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Ningguang accepts crit and attack. The Jade Chamber accounting team approves.",
    },

    noelle: {
        wants: ["DEF%", "Crit Rate", "Crit Damage", "Energy Recharge"],
        mainStats: ["DEF%", "Geo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Noelle wants DEF and crit. Maid service has entered combat mode.",
    },

    qiqi: {
        wants: ["ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "ATK%", "Healing Bonus"],
        verdict: "Qiqi wants ATK and healing. Paimon has forgotten why, but Qiqi probably has too.",
    },
    ...
    rosaria: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Cryo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Rosaria appreciates crit and ER. Church attendance remains optional.",
    },

    shenhe: {
        wants: ["ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "ATK%", "ATK%"],
        verdict: "Shenhe wants attack. A suspicious amount of attack.",
    },

    xiao: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Anemo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Xiao wants crit and attack. Emotional damage not included, but expected.",
    },
    ...
    yanfei: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Elemental Mastery"],
        mainStats: ["ATK%", "Pyro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Yanfei likes crit, attack, and legally defensible fire damage.",
    },

    yaoyao: {
        wants: ["HP%", "Energy Recharge", "Elemental Mastery"],
        mainStats: ["HP%", "HP%", "Healing Bonus"],
        verdict: "Yaoyao wants HP, ER, and responsible radish deployment.",
    },

    yunJin: {
        wants: ["DEF%", "Energy Recharge"],
        mainStats: ["DEF%", "DEF%", "DEF%"],
        verdict: "Yun Jin wants DEF and ER. Opera buff paperwork approved.",
    },
    ...
    gorou: {
        ...
        mainStats: ["Energy Recharge", "DEF%", "Geo DMG", "Crit Rate"],
        verdict:
    ...
    ayato: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Hydro DMG", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    kirara: {
        wants: ["HP%", "Energy Recharge", "Elemental Mastery"],
        mainStats: ["HP%", "HP%", "Elemental Mastery"],
        verdict:
    ...
    sayu: {
        ...
        mainStats: ["Elemental Mastery", "ATK%", "Healing Bonus"],
        verdict:
    ...
    thoma: {
        wants: ["HP%", "Energy Recharge", "Elemental Mastery"],
        mainStats: ["HP%", "Energy Recharge", "Elemental Mastery"],
        verdict:
    ...
    mizuki: {
        ...
        mainStats: ["Elemental Mastery", "Anemo DMG", "Elemental Mastery"],
        verdict:
            "Mizuki appreciates EM and dreamy swirl paperwork. Paimon remains cautiously awake.",
    },
    ...
    collei: {
        ...
        mainStats: ["Energy Recharge", "Elemental Mastery", "Dendro DMG", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    dehya: {
        ...
        mainStats: ["HP%", "ATK%", "Pyro DMG", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    faruzan: {
        wants: ["Energy Recharge", "Crit Rate", "Crit Damage"],
        mainStats: ["Energy Recharge", "Anemo DMG", "Crit Rate", "Crit Damage"],
        verdict:
            "Faruzan wants ER. Then more ER. Then perhaps an artifact if there is time.",
    },

    kaveh: {
        wants: ["Elemental Mastery", "Energy Recharge", "Crit Rate", "Crit Damage"],
        mainStats: ["Elemental Mastery", "Energy Recharge", "Dendro DMG", "Crit Rate", "Crit Damage"],
        verdict:
            "Kaveh appreciates EM and ER. Financial stability remains unavailable.",
    },

    layla: {
        wants: ["HP%", "Energy Recharge"],
        mainStats: ["HP%", "HP%", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    sethos: {
        wants: ["Elemental Mastery", "Crit Rate", "Crit Damage", "Energy Recharge"],
        mainStats: ["Elemental Mastery", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    freminet: {
        ...
        mainStats: ["ATK%", "Physical DMG", "Crit Rate", "Crit Damage"],
        verdict:
            "Freminet appreciates attack and crit. Social interaction remains optional.",
    },
    ...
    lanYan: {
        ...
        mainStats: ["Elemental Mastery", "Anemo DMG", "Elemental Mastery"],
        verdict:
            "Lan Yan prefers EM and ER. Bureaucratic wind currents detected.",
    },

    jean: {
        wants: ["ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Anemo DMG", "Healing Bonus"],
        verdict:
    ...
    mona: {
        wants: ["Energy Recharge", "Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["Energy Recharge", "Hydro DMG", "Crit Rate", "Crit Damage"],
        verdict:
    ...
    kaeya: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Cryo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Kaeya wants crit and attack. Suspiciously charming artifact behavior detected.",
    },
    ...
    mika: {
        wants: ["Energy Recharge", "HP%"],
        mainStats: ["Energy Recharge", "HP%", "Healing Bonus"],
        verdict: "Mika wants ER and support stats. Map-reading remains under review.",
    },

    tartaglia: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Hydro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Tartaglia likes crit, attack, and choosing violence on schedule.",
    },

    aloy: {
        wants: ["Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Cryo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Aloy wants crit and attack. Cross-dimensional paperwork approved.",
    },

    skirk: {
        wants: ["Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Cryo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Skirk wants crit and attack. Abyss-related training incident detected.",
    },
    ...
    iansan: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Iansan wants attack and crit. Training department approves the violence.",
    },

    ifa: {
        wants: ["Elemental Mastery", "Energy Recharge", "ATK%"],
        mainStats: ["Elemental Mastery", "Anemo DMG", "Elemental Mastery"],
        verdict: "Ifa prefers EM and ER. Paimon has filed this under airborne goblin medicine.",
    },

    varesa: {
        wants: ["Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["ATK%", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Varesa wants crit and attack. Paimon detects athletic thunder crimes.",
    },

    aino: {
        wants: ["Energy Recharge", "HP%", "Crit Rate", "Crit Damage"],
        mainStats: ["Energy Recharge", "HP%", "Hydro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Aino appreciates Hydro-adjacent competence. Paimon is cautiously optimistic.",
    },

    ineffa: {
        wants: ["Energy Recharge", "Crit Rate", "Crit Damage", "ATK%"],
        mainStats: ["Energy Recharge", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Ineffa wants ER and crit. Nod-Krai paperwork is humming suspiciously.",
    },

    lauma: {
        wants: ["Elemental Mastery", "Energy Recharge", "HP%"],
        mainStats: ["Elemental Mastery", "Dendro DMG", "Elemental Mastery"],
        verdict: "Lauma wants EM and mysterious forest math. Paimon will not question the plants.",
    },

    flins: {
        wants: ["Crit Rate", "Crit Damage", "ATK%", "Energy Recharge"],
        mainStats: ["ATK%", "Electro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Flins wants crit and attack. Paimon smells suspiciously professional lightning.",
    },

    nefer: {
        wants: ["Elemental Mastery", "Crit Rate", "Crit Damage"],
        mainStats: ["Elemental Mastery", "Dendro DMG", "Crit Rate", "Crit Damage"],
        verdict: "Nefer likes EM and crit. This artifact has entered the mysterious green department.",
    },

    linnea: {
        wants: ["DEF%", "Crit Rate", "Crit Damage", "Energy Recharge"],
        mainStats: ["DEF%", "Geo DMG", "Crit Rate", "Crit Damage"],
        verdict: "Linnea wants DEF and crit. Geo archive confirms suspiciously shiny rock behavior.",
    },
